...
class URxGrasping(VecTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        self.hand_index = self.gym.get_asset_rigid_body_dict(urx_asset)["dummy_center_indicator_link"]
        gripper_dofs = 6
        ...
        if self.physics_engine == gymapi.SIM_PHYSX:
            urx_dof_props["stiffness"][:self.urx_arm_dofs].fill(400.)
            urx_dof_props["damping"][:self.urx_arm_dofs].fill(40.)
            urx_dof_props["stiffness"][self.urx_arm_dofs:].fill(800.0)
            urx_dof_props["damping"][self.urx_arm_dofs:].fill(40.0)
        else:
        ...
        urx_dof_props['effort'][self.urx_arm_dofs:].fill(200)
